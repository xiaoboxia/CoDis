...
def noisify_multiclass_asymmetric_svhn(y_train, noise, random_state=None, nb_classes=10):
    """mistakes:
        flip in the symmetric way
    """
    P = np.eye(10)
...
def noisify_multiclass_asymmetric_news(y_train, noise, random_state=None, nb_classes=20):
    """mistakes:
        flip in the symmetric way
    """
    P = np.eye(20)
